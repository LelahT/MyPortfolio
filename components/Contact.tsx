        ...
        <div className="max-w-6xl h-full mx-auto flex flex-col gap-6 md:gap-12">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex flex-col items-center gap-3">
              <FaYoutube className="text-4xl text-designColor" />
              <p className="text-sm tracking-wide"><a href="https://www.youtube.com/channel/UC7BiQlLZ4f1xpwCOYsIpZzw"/>My Channel</p>
            </div>
            <div className="flex flex-col items-center gap-3">
              <FaLinkedin className="text-4xl text-designColor" />
              <p className="text-sm tracking-wide"><a href="https://www.linkedin.com/in/lelah-tehmeh/"></a></p>
            </div>
            <div className="flex flex-col items-center gap-3">
              <FaEnvelope className="text-4xl text-designColor" />
              <p className="text-sm tracking-wide">lelahtehmeh@gmail.com</p>
            </div>
          </div>
